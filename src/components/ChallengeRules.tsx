      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          <div>
            ...
            <div className="space-y-4">
              {rules.map((rule, index) => (
                <Card key={index} className="p-6 bg-gradient-card border-primary/20 hover:border-primary/40 transition-all duration-300">
            ...
            {/* Important Notes */}
            <Card className="mt-6 p-4 bg-secondary/10 border-secondary/40">
          ...
          <div>
              ...
              {prizes.map((prize, index) => (
                <Card 
                  ...
                  className={`p-6 transition-all duration-300 hover:scale-[1.02] ${
                    index === 0 
                      ? 'bg-gradient-thailand border-accent/40 shadow-thailand' 
                ...
                >
                  <div className="text-center">
                    <div className="mb-4">
                      <Badge 
                        variant="outline" 
                        className={`${index === 0 ? 'border-accent text-accent-foreground bg-accent/20' : 'border-primary text-primary'}`}
                      >
                        {prize.place}
                      </Badge>
                    </div>
            ...
            {/* Challenge Timeline */}
            <Card className="mt-6 p-6 bg-gradient-card border-primary/20">
            ...
            <div className="mt-6 text-center">
              <Button variant="thailand" size="lg" className="w-full">
